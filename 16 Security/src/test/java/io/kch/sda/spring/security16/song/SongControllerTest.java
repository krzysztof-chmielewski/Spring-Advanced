...
public class SongControllerTest {
    ...
    public void getRangeForMoreElements() throws Exception {
        ...
        SongBean third = new SongBean("Artist3", "Album3", "Title3");
        SongBean fourth = new SongBean("Artist4", "Album4", "Title4");
    ...
    public void putSong() throws Exception {
        ...
        SongBean expectedResult = new SongBean("ArtistNew", "AlbumNew", "TitleNew");
    ...
    @Test
    public void listByArtist() throws Exception {
        mockMvc.perform(get("/songs/artist/Artist"))
                .andExpect(status().isOk());

        verify(musicPlayer).filterByArtist("Artist");
    }
}